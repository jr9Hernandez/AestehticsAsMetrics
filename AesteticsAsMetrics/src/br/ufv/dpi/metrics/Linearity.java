...
public class Linearity extends Metrics { 
	...
	public Linearity(int width, int height, Level level) {
	...
	public double compute() {
		...
		for(int i=0;i<width;i++)
		{
			...
			else
			{
				...
				sumDifferences = sumDifferences + differences[i];
			}
		}
		double linearity = sumDifferences / (width-countGaps);
		return linearity;
	}
