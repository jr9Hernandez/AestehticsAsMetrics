...
public class CompressionDistance extends Metrics {

	private int tamCompresed1,tamCompresed2,tamCompresed3;

	public CompressionDistance(int width, int height, Level level) {
	...
	public double compute(Level toCompare) {
		...
		String string2 = countOtherElements(toCompare.getMap(), toCompare);

		string1 = string1 + CountenemCoins(level.getMap(), level);
		string2 = string2 + CountenemCoins(toCompare.getMap(), toCompare);
